...
export const CaptionGenerateHomePage = (props:CaptionGenerateHomePageProps) => {
  ...
  return (
    <>
      <div className="start-from-scratch flex flex-col gap-10">
        <h1 className="font-bold text-4xl">
          Generate post ideas and captions in seconds
        </h1>
        <div className="flex flex-col gap-5">
          <Link to={"medias"} className="bg-appPrimary hover:bg-appHover cursor-pointer rounded-xl text-white p-10 w-[40rem]">
            <h1 className="font-bold text-xl text-white">Start from Scratch</h1>
            <p>Generate new captions to engage, delight, or sell...</p>
          </Link>
          <Link to={"get-inspired"} className="bg-appPrimary hover:bg-appHover cursor-pointer rounded-xl text-white p-10 w-[40rem]">
